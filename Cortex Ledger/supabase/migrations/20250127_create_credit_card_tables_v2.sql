-- Migration: Create Credit Card Management Tables (Safe Version)
-- Description: Tables for managing credit cards, invoices, and installments
-- Author: Claude
-- Date: 2025-01-27
-- Note: Handles existing objects gracefully

-- ============================================
-- 1. Ensure cartao_credito table exists with all columns
-- ============================================
...
-- Create indexes for performance (drop first if exists to avoid conflicts)
...
-- ============================================
-- 11. Create or replace trigger function for updated_at
-- ============================================
