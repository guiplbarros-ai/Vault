      ...
      <Tabs defaultValue="timeline" className="space-y-4">
        ...
        <TabsContent value="costs" className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              <CardHeader className="pb-2">
                <CardTitle className="text-sm font-medium text-white">Total de Requisições</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            >
              <CardHeader className="pb-2">
                <CardTitle className="text-sm font-medium text-white">Custo Médio/Requisição</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            >
              <CardHeader className="pb-2">
                <CardTitle className="text-sm font-medium text-white">Economia com Regras</CardTitle>
              </CardHeader>
              <CardContent>
