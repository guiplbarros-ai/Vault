  ...
  const loadComparisonData = async () => {
    try {
      ...
      orcamentos.forEach(o => {
        const key = o.tipo === 'categoria' ? `Cat: ${o.categoria_nome || 'Desconhecida'}` : `CC: ${o.nome}`
  ...
  return (
    <Card className="p-6">
      <div className="mb-4">
        ...
        <p className="text-sm text-muted-foreground">Visualize o orçamento planejado vs gasto realizado</p>
      </div>
