        ...
        <div className="space-y-6">
          ...
          <div className="bg-secondary/50 rounded-lg p-4">
            ...
            <div className="flex items-baseline gap-2">
              ...
              <p className="text-sm text-muted-foreground">de {formatCurrency(currentSaving.income)}</p>
            </div>
              ...
              {savingData.map((data, index) => (
                <div key={index} className="flex items-center justify-between pb-2 border-b last:border-0">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className={`text-xs font-semibold w-12 text-right ${getRateColor(data.rate)}`}>
                      {data.rate.toFixed(0)}%
                    </span>
                  </div>
                </div>
