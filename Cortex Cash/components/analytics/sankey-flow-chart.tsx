      ...
      if (totalExpenses > 0) {
        ...
        monthTransactions
          ...
          .forEach(t => {
            ...
            totalByContaCategory[contaNome][catName] = (totalByContaCategory[contaNome][catName] || 0) + valor
          })
    ...
    <Card className="p-6">
      ...
      {data.nodes.length === 0 ? (
        ...
        <ResponsiveContainer width="100%" height={400}>
          ...
          >
            <Tooltip contentStyle={{ backgroundColor: colors.node, border: '1px solid ' + colors.link }} />
          </Sankey>
        </ResponsiveContainer>
      )}
    </Card>
