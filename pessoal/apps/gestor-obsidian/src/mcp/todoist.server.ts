      ...
      tools: [
        {
          ...
          inputSchema: {
            ...
            properties: {
              filter: {
                type: 'string',
                description: 'Filtro do Todoist (ex: "today", "p1", "@work")',
              },
              project: { type: 'string', description: 'Nome do projeto (busca aproximada)' },
              mine: {
                type: 'boolean',
                description:
                  'Se true, aplica "assigned to: me" (padrão: true). Use false para listar de todos.',
              },
            },
        ...
        },
        {
          ...
          inputSchema: {
            ...
            properties: {
              ...
              parentId: {
                type: 'string',
                description: 'ID da tarefa pai (para criar como subtask)',
              },
              assignee: {
                type: 'string',
                description:
  ...
  server.setRequestHandler(CallToolRequestSchema, async (request) => {
    ...
    switch (name) {
      ...
      case 'todoist_complete_task': {
        ...
        return {
          content: [
            { type: 'text', text: `✓ Tarefa concluída: "${task.content}" (ID: ${taskId})` },
          ],
        }
      }
