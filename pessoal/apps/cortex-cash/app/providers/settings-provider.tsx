...
import type { Settings, SettingsCategory, SettingsChangeEvent } from '@/lib/types/settings'
...
export function SettingsProvider({ children }: { children: ReactNode }) {
  ...
  const subscribe = useCallback(
    (path: string, callback: (value: any, event: SettingsChangeEvent) => void) => {
 ...
 */
export function useSettingsCategory<K extends SettingsCategory>(category: K): Settings[K] {
  ...
  const handleCategoryChange = useCallback(
    (_: any, event: SettingsChangeEvent) => {
