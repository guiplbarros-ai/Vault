            ...
            <>
              ...
              <div className="grid grid-cols-2 gap-4 mt-4">
                ...
                <div>
                  ...
                  <p className="text-sm">
                    {new Date(data.session.expiresAt).toLocaleString('pt-BR')}
                  </p>
                </div>
                <div>
          ...
          <CardContent>
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="text-sm">
                  {new Date(data.currentUser.created_at).toLocaleString('pt-BR')}
                </p>
              </div>
              <div>
          ...
          {data.session && data.currentUser && data.currentUser.ativo && (
            <div className="mt-6 p-4 bg-green-500/10 border border-green-500/20 rounded-lg">
              <p className="text-sm">
                ...
                elas serão automaticamente associadas ao usuário{' '}
                <strong>{data.currentUser.nome}</strong>
              </p>
