      ...
      <div className="space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          ...
          <Card>
            <CardHeader className="pb-3">
              ...
              <p className="mt-1 text-xs text-muted-foreground">Rendimento total</p>
            </CardHeader>
          </Card>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Visualize e gerencie seus ativos e investimentos</CardDescription>
          </CardHeader>
          <CardContent>
                      ...
                      <div className="space-y-4">
                        ...
                        >
                          ...
                          <div className="text-sm text-foreground">
                            R${' '}
                            {patrimonio.saldo_contas.toLocaleString('pt-BR', {
                              minimumFractionDigits: 2,
                              maximumFractionDigits: 2,
                            })}
                          </div>
                        ...
                        >
                          ...
                          <div className="text-sm text-foreground">
                            R${' '}
                            {patrimonio.saldo_investimentos.toLocaleString('pt-BR', {
                              minimumFractionDigits: 2,
                              maximumFractionDigits: 2,
                            })}
                          </div>
                        ...
                        <div className="flex items-center justify-between pt-3">
                          ...
                          <div className="text-base font-bold text-foreground">
                            R${' '}
                            {patrimonio.patrimonio_total.toLocaleString('pt-BR', {
                              minimumFractionDigits: 2,
                              maximumFractionDigits: 2,
                            })}
                          </div>
                ...
                {investimentos.length === 0 ? (
                  <Card>
                    <CardContent className="flex flex-col items-center justify-center py-12">
                      ...
                      <Button onClick={() => setShowNewInvestmentDialog(true)} className="px-5">
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>Todos os seus investimentos ativos</CardDescription>
                    </CardHeader>
                    <CardContent>
                            ...
                            >
                              <div className="space-y-1 flex-1">
                                ...
                                <div className="text-xs text-muted-foreground">
                                  {inv.tipo.replace('_', ' ')} • Aplicado: R${' '}
                                  {inv.valor_aplicado.toLocaleString('pt-BR', {
                                    minimumFractionDigits: 2,
                                  })}
                                </div>
                              </div>
                              <div className="text-right space-y-1">
                                <div className="font-medium text-foreground">
                                  R${' '}
                                  {inv.valor_atual.toLocaleString('pt-BR', {
                                    minimumFractionDigits: 2,
                                  })}
                                </div>
                                <div
      ...
      <Dialog open={showNewInvestmentDialog} onOpenChange={setShowNewInvestmentDialog}>
        <DialogContent className="sm:max-w-[700px] max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>Cadastre um novo investimento no seu portfólio</DialogDescription>
          </DialogHeader>
          <InvestmentForm
