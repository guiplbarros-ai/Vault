              ...
              >
                ...
                <CardContent className="space-y-2 text-sm font-mono">
                  ...
                  <div className="text-white/80">
                    ...
                    <span
                      className="ml-2 inline-block w-6 h-6 rounded border border-white/20"
                      style={{ backgroundColor: account.cor || '#gray' }}
                    ></span>
                    <span className="ml-2">{account.cor || 'undefined'}</span>
                  </div>
                  <div className="text-white/80">
                    <strong className="text-white">conta_pai_id:</strong>{' '}
                    {account.conta_pai_id || 'undefined'}
                  </div>
                  {parentAccount && (
                  ...
                  {account.conta_pai_id && !parentAccount && (
                    <div className="mt-2 p-3 bg-red-500/20 border border-red-500/30 rounded">
                      ...
                      <span className="text-red-200">
                        {' '}
                        conta_pai_id aponta para conta inexistente
                      </span>
                    </div>
                  )}
