...
import {
  ...
  clearBankTemplates,
  seedBankTemplates,
} from '@/lib/import/templates/seed-templates'
  ...
  return (
    <div className="min-h-screen bg-gray-950 p-8">
      <div className="max-w-2xl mx-auto">
        <h1 className="text-3xl font-bold text-white mb-2">Seed de Templates de Importação</h1>
        <p className="text-gray-400 mb-8">
          Ferramenta de desenvolvimento para popular o banco com templates pré-configurados de
          bancos brasileiros
        </p>
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  {result.count !== undefined && (
                    <p className="text-gray-400 text-sm mt-1">Total: {result.count} templates</p>
                  )}
                </div>
              </div>
            )}
        ...
        <div className="mt-6 text-center">
          <a href="/import" className="text-blue-400 hover:text-blue-300 underline">
