    ...
    <DashboardLayout>
      <div className="space-y-6">
        <PageHeader
          ...
          actions={
            <Button size="lg" className="px-6 text-base font-semibold">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <Card>
            <CardHeader className="pb-3">
              ...
              <p className="mt-1 text-xs text-muted-foreground">Cadastradas no sistema</p>
            </CardHeader>
          </Card>
          ...
          <Card>
            <CardHeader className="pb-3">
              ...
              <p className="mt-1 text-xs text-muted-foreground">Ano-calendário 2025</p>
            </CardHeader>
          </Card>
        </div>
