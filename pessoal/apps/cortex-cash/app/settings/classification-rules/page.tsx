...
import { AlertCircle, Edit, Eye, GripVertical, Plus, Power, Search, Trash2 } from 'lucide-react'
...
export default function ClassificationRulesPage() {
  ...
  const filteredRegras = regras.filter((regra) => {
    ...
    const matchesFilter = filterAtiva === null || regra.ativa === filterAtiva
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-white/70">Crie regras para classificar transações automaticamente</p>
          </div>
        ...
        <AlertDialog open={!!deletingRule} onOpenChange={() => setDeletingRule(null)}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                Tem certeza que deseja excluir a regra <strong>{deletingRule?.nome}</strong>? Esta
    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        <Button
          ...
          className={cn('hover:bg-white/10', regra.ativa ? 'text-green-400' : 'text-white/40')}
        >
