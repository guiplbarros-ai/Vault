...
export function PerformanceSection() {
  ...
  const [preloadDashboards, setPreloadDashboards] = useSetting<boolean>(
    'performance.preloadDashboards'
  )
  const [autoClearCache, setAutoClearCache] = useSetting<boolean>('performance.autoClearCache')
  const [cacheClearFrequency, setCacheClearFrequency] = useSetting<'on_close' | 'daily' | 'weekly'>(
    'performance.cacheClearFrequency'
  )
  ...
  return (
    <div className="space-y-6">
      <SettingsCard title="Cache" description="Configure o cache para melhorar a performance">
        <SettingsToggle
          label="Ativar cache"
            ...
            <div className="pt-4 border-t border-white/10">
              <div className="flex items-start gap-4">
                <div className="flex-1">
                  <div className="text-sm font-medium text-white mb-1">Limpar cache agora</div>
      ...
      <SettingsCard title="Carregamento" description="Configure como os dados são carregados">
        <SettingsToggle
          label="Lazy loading"
      ...
      <SettingsCard title="Animações" description="Configure animações visuais">
        <SettingsToggle
