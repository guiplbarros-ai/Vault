    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between rounded-lg border border-white/20 p-4 bg-white/5">
        <div className="space-y-0.5">
          ...
          <p className="text-sm text-white/60">Habilita o botão para popular dados de exemplo</p>
        </div>
        <Switch
          id="demo-mode"
      ...
      <div className="rounded-lg border border-amber-500/30 bg-amber-500/10 p-4">
        <div className="flex items-start gap-3">
          ...
          <div className="text-sm text-white/80">
            ...
            <p>
              O botão "Limpar Dados" irá <strong>remover TODAS as contas e transações</strong> do
              banco de dados, independentemente do modo demo estar ativo ou não. Certifique-se de
