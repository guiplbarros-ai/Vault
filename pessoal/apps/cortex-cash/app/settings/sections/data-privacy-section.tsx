...
export function DataPrivacySection() {
  ...
  const [backupFrequency, setBackupFrequency] = useSetting<'daily' | 'weekly' | 'monthly'>(
    'dataPrivacy.backupFrequency'
  )
  ...
  return (
    <div className="space-y-6">
      ...
      <SettingsCard title="Privacidade" description="Controle de dados e telemetria">
        <SettingsToggle
          label="Telemetria"
        ...
        <div className="flex flex-col gap-3">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-white/70">Salvar suas configurações em arquivo JSON</p>
            </div>
            <Button
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-white/70">Restaurar configurações de um arquivo</p>
            </div>
            <Button
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-white/70">Voltar às configurações de fábrica</p>
            </div>
