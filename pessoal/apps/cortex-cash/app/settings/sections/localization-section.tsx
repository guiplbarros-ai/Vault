...
export function LocalizationSection() {
  ...
  const [dateFormat, setDateFormat] = useSetting<'DD/MM/YYYY' | 'MM/DD/YYYY' | 'YYYY-MM-DD'>(
  ...
  const [decimalSeparator, setDecimalSeparator] = useSetting<',' | '.'>(
  ...
  return (
    <div className="space-y-6">
      <SettingsCard title="Idioma e Região" description="Configure o idioma e formatos regionais">
        <SettingsSelect
          label="Idioma"
