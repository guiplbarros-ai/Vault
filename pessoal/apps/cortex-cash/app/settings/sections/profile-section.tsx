...
import { type UpdatePerfilDTO, usuarioService } from '@/lib/services/usuario.service'
      ...
      >
        <div className="flex items-center gap-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs mt-2 text-foreground/50">JPG, PNG ou GIF. Máximo 5MB.</p>
          </div>
        </div>
      </SettingsCard>

      {/* Informações Pessoais */}
      <SettingsCard title="Informações Pessoais" description="Gerencie suas informações básicas">
