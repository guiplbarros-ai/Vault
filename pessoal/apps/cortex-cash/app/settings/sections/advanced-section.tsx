...
export function AdvancedSection() {
  ...
  const [logLevel, setLogLevel] = useSetting<'error' | 'warn' | 'info' | 'debug'>(
    'advanced.logLevel'
  )
  ...
  return (
    <div className="space-y-6">
      ...
      {devMode && (
        <SettingsCard title="Experimentos" description="Features experimentais em desenvolvimento">
          <div className="rounded-lg border border-amber-500/50 bg-amber-500/10 p-4">
            <p className="text-sm text-amber-600 dark:text-amber-400">
              <strong>⚠️ Aviso:</strong> Recursos experimentais podem ser instáveis ou mudar a
              qualquer momento.
            </p>
          </div>
