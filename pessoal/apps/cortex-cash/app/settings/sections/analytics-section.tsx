...
/**
 * Analytics Section for Settings
 * Agent APP: Owner
 *
 * Seção de métricas consolidadas de classificação automática e IA
 */
...
import { Award, DollarSign, Sparkles, Target, Zap } from 'lucide-react'
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        >
          ...
          <CardContent>
            ...
            <p className="text-xs text-white/60 mt-1">
              {overview.by_rules + overview.by_ai} automáticas (
              {Math.round(
                ((overview.by_rules + overview.by_ai) / overview.total_classifications) * 100
              )}
              %)
            </p>
          </CardContent>
        ...
        >
          ...
          <CardContent>
            <div className="text-3xl font-bold text-green-400">{overview.accuracy_rate}%</div>
            <p className="text-xs text-white/60 mt-1">
        ...
        >
          ...
          <CardContent>
            ...
            <p className="text-xs text-white/60 mt-1">{overview.by_ai} classificações com IA</p>
          </CardContent>
        </Card>
        ...
        >
          ...
          <CardContent>
            <div className="text-3xl font-bold text-blue-400">{overview.by_rules}</div>
            <p className="text-xs text-white/60 mt-1">Classificações sem custo</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Tabs defaultValue="timeline" className="space-y-4">
        ...
        <TabsContent value="timeline" className="space-y-4">
          ...
          >
            <CardHeader>
              <CardTitle className="text-white">Classificações ao Longo do Tempo</CardTitle>
              <CardDescription className="text-white/60">
                Distribuição de classificações por origem (últimos{' '}
                {timeRange === '3m' ? '3' : timeRange === '6m' ? '6' : '12'} meses)
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          >
            <CardHeader>
              <CardTitle className="text-white">Taxa de Acurácia ao Longo do Tempo</CardTitle>
              <CardDescription className="text-white/60">
        ...
        <TabsContent value="costs" className="space-y-4">
          ...
          >
            <CardHeader>
              <CardTitle className="text-white">Custos de IA por Mês</CardTitle>
              <CardDescription className="text-white/60">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="font-semibold text-white">
                      {Math.round(
                        ((overview.by_rules + overview.by_ai) / overview.total_classifications) *
                          100
                      )}
                      %
                    </span>
