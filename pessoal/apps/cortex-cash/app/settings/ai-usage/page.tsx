  ...
  const applyFilters = () => {
    ...
    if (searchTerm.trim()) {
      ...
      filtered = filtered.filter(
        (log) =>
          log.prompt?.toLowerCase().includes(term) || log.resposta?.toLowerCase().includes(term)
      )
    }
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-white/70">Auditoria de uso e gastos com OpenAI (mês atual)</p>
          </div>
            ...
            >
              ...
              <div className="text-2xl font-bold text-white">
                {stats.confirmed_suggestions + stats.rejected_suggestions > 0
                  ? (
                      (stats.confirmed_suggestions /
                        (stats.confirmed_suggestions + stats.rejected_suggestions)) *
                      100
                    ).toFixed(0)
                  : 0}
                %
        ...
        >
          ...
          <div className="p-4 border-b border-white/10 space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              ...
              <Select
                value={filterModel}
                onValueChange={(value) => setFilterModel(value as FilterModel)}
              >
                <SelectTrigger className="bg-white/5 border-white/10 text-white">
