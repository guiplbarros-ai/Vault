...
import { AlertCircle, Clock, Sparkles, Target, TrendingDown, TrendingUp } from 'lucide-react'
...
export function BudgetOverview() {
  ...
  return (
    <Card
      className="p-6 shadow-md border-border overflow-hidden flex flex-col h-full bg-gradient-to-br from-card to-background"
      style={{
        minHeight: '520px',
      }}
    >
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-muted-foreground">
            {viewMode === 'valores_absolutos'
              ? 'Top 4 maiores gastos'
              : 'Top 4 maiores variações vs mês anterior'}
          </p>
        </div>
        <Select value={viewMode} onValueChange={(value) => setViewMode(value as ViewMode)}>
          ...
          <SelectContent className="bg-card border-border">
            <SelectItem
              ...
              className="text-sm font-medium cursor-pointer hover:bg-muted"
            >
              Maiores Valores
            </SelectItem>
            <SelectItem
          ...
          {budgets.map((budget) => {
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center justify-between mb-3">
                          ...
                          >
                            {budget.variacao_absoluta && budget.variacao_absoluta > 0
                              ...
                              : budget.variacao_absoluta && budget.variacao_absoluta < 0
                                ? '↓'
                                : '='}{' '}
                            {Math.abs(budget.variacao_percentual).toFixed(0)}%
                          </span>
                        )}
                        {budget.tendencia && (
                          <Badge
                  ...
                  <div className="flex flex-col items-end">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      >
                        {isPositive ? 'Disponível' : 'Excedido'} R${' '}
                ...
                {budget.previsao_fim_mes !== undefined &&
                  budget.ritmo_gasto !== undefined &&
                  budget.dias_restantes !== undefined && (
                    <div className="mt-3 p-3 rounded-lg border bg-muted/40 border-border/50">
                      ...
                      <div className="grid grid-cols-3 gap-3">
                        <div className="flex flex-col">
                          ...
                          >
                            R${' '}
                            {budget.previsao_fim_mes.toLocaleString('pt-BR', {
                              minimumFractionDigits: 2,
                              maximumFractionDigits: 2,
                            })}
                          </span>
                        ...
                        <div className="flex flex-col">
                          ...
                          <span className="text-sm font-bold text-foreground">
                            R${' '}
                            {budget.ritmo_gasto.toLocaleString('pt-BR', {
                              minimumFractionDigits: 2,
                              maximumFractionDigits: 2,
                            })}
                          </span>
