...
import type { HealthCheckResult, HealthStatus } from '@/lib/monitoring/types'
    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>Unable to perform health check: {error.message}</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Badge variant={overallConfig.badgeVariant} className="text-sm px-3 py-1">
              {overallConfig.label}
            </Badge>
      ...
      <CardContent>
        ...
        <div className="mt-6 pt-6 border-t">
          <div className="flex items-center justify-between text-sm text-muted-foreground">
            ...
            <span>{health.checks.length} checks performed</span>
          </div>
        </div>
      </CardContent>
    </Card>
