    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="text-center p-4 rounded-lg bg-gradient-to-br from-[#18B0A4]/20 to-[#18B0A4]/5 border border-[#18B0A4]/30">
          ...
          <div className="text-sm text-white/60">Taxa de Aceitação de Sugestões</div>
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between text-sm">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-white font-medium w-12 text-right">{stats.por_regra}</span>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between text-sm">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-white font-medium w-12 text-right">{stats.por_ia}</span>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between text-sm">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-white font-medium w-12 text-right">{stats.manuais}</span>
            </div>
          </div>
        </div>
