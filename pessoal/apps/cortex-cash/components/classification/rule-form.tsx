...
import { AlertCircle, Eye, HelpCircle } from 'lucide-react'
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            As regras são aplicadas por ordem de prioridade (maior primeiro) e param na primeira que
            casar.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <Input
                ...
                placeholder={tipoRegra === 'regex' ? 'Ex: ^(uber|99).*' : 'Ex: subway'}
                className="font-mono"
                disabled={loading}
              />
              <Button
            ...
            {tipoRegra === 'regex' && (
              <p className="text-xs text-yellow-500 flex items-start gap-1">
                ...
                Use expressões regulares válidas. Flags: case-insensitive (i) aplicada
                automaticamente.
              </p>
            )}
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              min={1}
              value={prioridade}
              onChange={(e) => setPrioridade(Number.parseInt(e.target.value) || 1)}
              disabled={loading}
            />
          </div>
