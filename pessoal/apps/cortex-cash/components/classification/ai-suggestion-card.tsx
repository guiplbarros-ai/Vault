...
export function AISuggestionCard({
  ...
  const confidenceColor =
    confianca >= 0.8 ? 'text-green-500' : confianca >= 0.6 ? 'text-yellow-500' : 'text-orange-500'
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-start justify-between gap-2">
          <div className="flex-1">
            <p className="text-sm font-medium text-foreground line-clamp-2">{transacaoDescricao}</p>
            {categoriaAtualNome && (
              <p className="text-xs text-muted-foreground mt-1">Atual: {categoriaAtualNome}</p>
            )}
          </div>
        ...
        <div className="flex items-center gap-2 p-3 rounded-lg bg-muted/50 border">
          ...
          <div className="flex-1">
            <p className="text-sm font-semibold text-foreground">{categoriaSugeridaNome}</p>
