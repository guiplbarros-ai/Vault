...
import { Brain, Pencil, Plus, Power, Trash2 } from 'lucide-react'
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription className="text-white/70">
              Configure regras para classificar automaticamente suas transações. Regras são
              aplicadas antes da IA.
            </CardDescription>
          </div>
          <Button
            onClick={handleNew}
      ...
      <CardContent>
        {regras.length === 0 ? (
          <div className="text-center py-12">
            <p className="text-white/70 mb-4">Nenhuma regra configurada ainda.</p>
              ...
              <TableBody>
                {regras.map((regra) => (
                  <TableRow key={regra.id} className="border-white/20">
                    <TableCell className="text-white font-medium">{regra.prioridade}</TableCell>
                    ...
                    <TableCell className="text-white/70">{regra.total_aplicacoes}</TableCell>
                    <TableCell>
                      <Badge
                        style={{
