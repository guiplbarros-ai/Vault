    ...
    >
      <CardHeader className="pb-3">
        <div className="flex items-start justify-between">
          ...
          {percentual_usado >= 70 && <AlertTriangle className="h-5 w-5 text-warning" />}
        </div>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between text-sm">
            ...
            <span
              className={`font-semibold ${percentual_usado >= 90 ? 'text-destructive' : percentual_usado >= 70 ? 'text-warning' : 'text-success'}`}
            >
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="space-y-1">
            ...
            <p
              className={`text-sm font-semibold ${percentual_usado >= 90 ? 'text-destructive' : percentual_usado >= 70 ? 'text-warning' : 'text-success'}`}
            >
