...
import { AlertCircle, AlertTriangle, Download, Info, Trash2, Upload } from 'lucide-react'
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground mt-3">
            This will download all transactions, accounts, categories, and other data. Keep this
            file safe as it contains all your financial information.
          </p>
        </CardContent>
      </Card>
        ...
        <CardContent className="space-y-4">
          <div>
            ...
            <label htmlFor="backup-file-input">
              <Button variant="outline" className="w-full sm:w-auto" disabled={loading} asChild>
                <span>
            ...
            <div className="space-y-3">
                ...
                <AlertDescription>
                  <div className="space-y-1 text-sm">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span>{new Date(backupInfo.metadata.timestamp).toLocaleString()}</span>
                    </div>
                  </div>
                </AlertDescription>
              </Alert>
              ...
              <Alert>
                ...
                <AlertDescription className="text-sm">
                  <strong>Warning:</strong> Importing will replace all existing data. Make sure to
        ...
        <CardContent className="space-y-4">
          {showClearConfirm && (
            <Alert variant="destructive">
              <AlertCircle className="h-4 w-4" />
              <AlertDescription>
                <strong>Are you absolutely sure?</strong> This action cannot be undone. All your
                transactions, accounts, categories, and other data will be permanently deleted.
              </AlertDescription>
            </Alert>
          )}
