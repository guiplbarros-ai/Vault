...
import { type CartaoFormData, cartaoSchema } from '@/lib/validations'
    ...
    <FormProvider {...methods}>
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="form-dark-input">
            <FormCurrencyInput name="limite_total" label="Limite Total" currency="BRL" required />
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="text-xs p-3 rounded-md bg-muted text-foreground/90">
            ...
            <ul className="space-y-1 list-disc list-inside">
              <li>
                <strong>Dia de Fechamento:</strong> Último dia para compras entrarem na fatura atual
              </li>
              <li>
                <strong>Dia de Vencimento:</strong> Data limite para pagar a fatura
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <FormColorPicker name="cor" label="Cor" colors={CARD_COLORS} required />
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="form-dark-select">
            ...
            <p className="text-xs mt-2 text-foreground/70">
              Ao selecionar uma conta-corrente, o pagamento da fatura será debitado automaticamente
              dessa conta
            </p>
          </div>
        </div>
        ...
        <div className="flex justify-end gap-3 pt-4">
          ...
          <Button type="submit" disabled={isLoading} className="bg-primary text-foreground">
