...
import type { Categoria, Conta, Tag } from '@/lib/types'
import { type TransactionFormData, transactionSchema } from '@/lib/validations'
    ...
    <FormProvider {...methods}>
      <form onSubmit={methods.handleSubmit(handleSubmit)} className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <FormDatePicker name="date" label="Data" placeholder="Selecione a data" required />
        </div>
