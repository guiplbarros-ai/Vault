      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <FormSelect name="tipo" label="Tipo" options={INVESTMENT_TYPE_OPTIONS} required />
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <FormInput name="data_aplicacao" label="Data de Aplicação" type="date" required />
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <FormColorPicker name="cor" label="Cor" description="Cor para identificação visual" />
          </div>
