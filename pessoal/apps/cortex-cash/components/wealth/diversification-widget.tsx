  ...
  if (loading) {
    return (
      <Card className="bg-card">
        <CardHeader>
          <CardTitle className="text-foreground">Análise de Diversificação</CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <span className="text-sm font-medium text-foreground">Contas vs Investimentos</span>
          </div>
        ...
        {data.por_tipo_investimento.length > 0 && (
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <span className="text-sm font-medium text-foreground">Tipos de Investimento</span>
            </div>
            <div className="space-y-3">
        ...
        {data.por_tipo_conta.length > 0 && (
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <span className="text-sm font-medium text-foreground">Tipos de Conta</span>
            </div>
            <div className="space-y-3">
