    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>Nenhuma despesa classificada neste mês</CardDescription>
        </CardHeader>
      </Card>
    )
  }
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>Total: {formatCurrency(totalGastos)}</CardDescription>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Top 8 categorias</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Categorias ordenadas por valor</CardDescription>
          </CardHeader>
          <CardContent>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-semibold">{formatCurrency(cat.total_gasto)}</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div
      ...
      {variacoes.length > 0 && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>Top 5 maiores variações</CardDescription>
          </CardHeader>
          <CardContent>
                    ...
                    >
                      ...
                      <div className="flex items-center gap-4">
                        <div className="text-right">
                          <p className="font-semibold">{formatCurrency(v.total_gasto_atual)}</p>
                          <p className="text-muted-foreground text-sm">
