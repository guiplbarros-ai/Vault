...
export function CategoryMergeDialog({
  ...
  useEffect(() => {
    async function loadPreview() {
      ...
      try {
        const count = await categoriaService.contarTransacoesPorCategoria(categoriaOrigem.id)
        setPreview({
          transacoes: count,
  ...
  const handleMerge = async () => {
    ...
    try {
      setLoading(true)
      await categoriaService.mesclarCategorias(categoriaOrigem.id, categoriaDestinoId)
  ...
  const categoriaDestino = categoriasCompativeis.find((c) => c.id === categoriaDestinoId)
      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Todas as transações e dados da categoria origem serão transferidos para a categoria
              destino. A categoria origem será desativada.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4 pt-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2 p-3 bg-muted rounded-md">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-muted-foreground">Será desativada após a mesclagem</p>
                </div>
              </div>
            </div>
              ...
              <Alert>
                ...
                <AlertDescription>
                  ...
                  <ul className="text-sm space-y-1">
                    ...
                    {preview.orcamentos > 0 && <li>• {preview.orcamentos} orçamentos</li>}
                    {preview.regras > 0 && <li>• {preview.regras} regras de classificação</li>}
                  </ul>
                </AlertDescription>
              </Alert>
            )}
            ...
            {categoriaOrigem &&
              categoriaDestino &&
              categoriaOrigem.tipo !== categoriaDestino.tipo && (
      ...
      <AlertDialog open={confirmDialogOpen} onOpenChange={setConfirmDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Tem certeza que deseja mesclar <strong>{categoriaOrigem?.nome}</strong> com{' '}
