...
export interface ITemplateService {
   ...
   */
  createTemplate(
    data: Omit<TemplateImportacao, 'id' | 'created_at' | 'updated_at'>
...
export interface IRegraService {
  ...
  createRegra(
    data: Omit<
      RegraClassificacao,
      'id' | 'created_at' | 'updated_at' | 'total_aplicacoes' | 'ultima_aplicacao'
    >
...
export interface IOrcamentoService {
  ...
  updateOrcamento(
    id: string,
    data: Partial<Omit<Orcamento, 'id' | 'created_at' | 'updated_at'>>
  ): Promise<Orcamento>
...
export interface ICartaoService {
  ...
  updateCartao(
    id: string,
    data: Partial<Omit<CartaoConfig, 'id' | 'created_at' | 'updated_at'>>
