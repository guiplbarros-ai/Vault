 ...
 */
export function formatDate(date: Date | string | number, formatString = 'dd/MM/yyyy'): string {
 ...
 */
export function parseDate(dateString: string, formatString = 'dd/MM/yyyy'): Date | null {
  try {
