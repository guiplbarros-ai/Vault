 ...
 */
export type UICategory = SettingsCategory | 'profile' | 'analytics' | 'demoMode' | 'admin' | 'pluggy'

/**
 * Value type baseado no path
 */
export type SettingsValue<T extends SettingsPath> = T extends `${infer Category}.${infer Key}`
